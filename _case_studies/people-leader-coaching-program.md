...
featured: true
featured_order: 2
featured_icon: ph-chats-circle
featured_blurb: "Rebuilt LinkedIn's coaching certification after the original lost most participants."
intro: >
...
stats:
  - number: "~70%"
    label: Dropout rate before the redesign
    icon: ph-trend-down
  - number: "90%+"
    label: Managers certified post-redesign
    icon: ph-seal-check
  - number: "6 weeks"
    label: Redesign sprint, on time and under budget
    icon: ph-clock
---
Managers reported stronger engagement and better sales results from coaching more, and the approach was adopted as a template for other lines of business. Capstone scoring and certification were tracked through Cornerstone (CSOD), the LMS I configured for GTM Enablement.
